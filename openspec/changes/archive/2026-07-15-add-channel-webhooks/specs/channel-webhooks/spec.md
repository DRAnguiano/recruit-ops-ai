...
- **THEN** the payload is handed to ingestion and the API responds 200

#### Scenario: Invalid signature
- **WHEN** the signature header is missing or does not match
- **THEN** the API responds 403 and nothing is persisted
...
- **THEN** the update is handed to ingestion and the API responds 200
