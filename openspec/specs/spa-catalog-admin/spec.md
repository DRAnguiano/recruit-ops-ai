...
Give operators a single "Administración" view in the SPA to edit everything the product
treats as configurable business data — domain catalogs, goals per period and operational
settings — without ever touching code (rule 1, `openspec/project.md` §2).
