# spa-capacity-empty-states

## Purpose

La vista de Capacidad muestra secciones cuyos datos no siempre están cargados (flota, metas
mensuales, capacidad por circuito). Esta capability define que cada sección se oculta cuando no
tiene datos y que la pestaña muestra un empty-state explicativo cuando ninguna los tiene,
distinguiendo «cero real» de «sin datos».
