...
Oferta versionada por campaña (borrador → publicación inmutable), con el contenido completo de lo
que se promete al candidato — primer caso real del patrón «borrador → publicación inmutable;
evaluaciones referencian versión» (project.md §6).
