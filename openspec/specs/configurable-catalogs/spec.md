...
Operational domain values (companies, circuits, vacancy types, lead statuses) live as
catalog data editable from the UI — never as code enums — per project rule 1
("nada de negocio hardcodeado").
