...
Persistir el cruce candidato↔operador por teléfono (incluye celular de pareja/familiar, ya fusionado
en `normalizedPhones` al importar el directorio) cuando es unívoco, y reportarlo cuando es ambiguo
— nunca adivinar. Reutiliza el mismo camino que la vinculación manual, así que abre el episodio
laboral inmutable correspondiente.
