...
Permitir recalcular bajo demanda las métricas de horario hábil derivadas de los leads existentes
(`inWorkHours`, `arrivalHour`, `arrivalDay`) contra el `work_schedule` vigente, para cuando el
horario oficial cambie sin re-ingerir mensajes.
